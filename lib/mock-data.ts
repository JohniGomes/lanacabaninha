...
export const colecoes: Colecao[] = [
  ...
  { id: "jardim-secreto", nome: "Jardim Secreto", emoji: "🌸", descricao: "Flores, borboletas e folhagens." },
  { id: "cherry-dream", nome: "Cherry Dream", emoji: "🍒", descricao: "Cerejas, laços, corações, poás e detalhes retrô." },
  { id: "coquette", nome: "Coquette", emoji: "🎀", descricao: "Laços, rendas, pérolas, corações e fitas delicadas." },
  { id: "boho-soul", nome: "Boho Soul", emoji: "🌾", descricao: "Macramê, capim dos pampas e filtro dos sonhos." },
  { id: "glow-party", nome: "Glow Party", emoji: "✨", descricao: "Neon, luz negra e muito brilho." },
  { id: "sweet-hearts", nome: "Sweet Hearts", emoji: "💖", descricao: "Corações, laços e luzinhas." },
  { id: "noite-magica", nome: "Noite Mágica", emoji: "🌙", descricao: "Lua, constelações, estrelas, lanternas e brilhos delicados." },
  { id: "fundo-do-mar", nome: "Fundo do Mar", emoji: "🧜‍♀️", descricao: "Sereias, estrelas-do-mar, conchas e elementos marinhos." },
];
